...
public class LoginRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the dpUserDTO value for this LoginRequest.
     * 
     * @return dpUserDTO
     */
    ...
    /**
     * Sets the dpUserDTO value for this LoginRequest.
     * 
     * @param dpUserDTO
     */
    ...
    /**
     * Gets the dpServicesConnectionDTO value for this LoginRequest.
     * 
    ...
    /**
     * Sets the dpServicesConnectionDTO value for this LoginRequest.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.novatec.com.ve/novatecws/", ">loginRequest"));
